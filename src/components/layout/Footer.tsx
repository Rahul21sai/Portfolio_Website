    ...
    <footer className="relative bg-surface border-t border-border py-12">
      <div className="container-custom">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            © {new Date().getFullYear()} {personalData.shortName} · Built with React + Three.js
          </motion.div>
          ...
          <motion.button
            onClick={scrollToTop}
            className="flex items-center gap-2 text-text-muted hover:text-accent-violet transition-colors text-sm group"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        {/* Decorative Line */}
        <motion.div
          className="mt-8 h-px bg-gradient-to-r from-transparent via-accent-violet to-transparent"
          initial={{ scaleX: 0 }}
